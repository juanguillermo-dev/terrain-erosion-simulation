...
struct TerrainDSOut
{
    ...
    float3 WorldPos : POSITION;  // Posición en espacio de mundo para cálculos de iluminación
    float2 uv : TEX_COORD;
};
...
struct GlobalConstants
{
    ...
    float ErosionLevel;     // Nivel actual de erosión 
    float Dummy;            // Para alineación

    float4x4 WorldView;
    float4x4 WorldViewProj;
    float4x4 World;        // Matriz de mundo para cálculos de iluminación
    float4 ViewportSize;
};